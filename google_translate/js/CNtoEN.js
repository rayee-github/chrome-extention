...
document.addEventListener("mousemove", function (e){
  ...
  {
    var x = mx + document.body.scrollLeft + document.documentElement.scrollLeft + 10;
    var y = my + document.body.scrollTop + document.documentElement.scrollTop + 10;
...
function GetSelectText()
{
  ...
  if(t!='')
  {
	...
	{
	  chrome.runtime.sendMessage({contentScriptQuery: "query",language:"ZH_CN2EN", text: t.toString()},string => json_parse(string));
	}
